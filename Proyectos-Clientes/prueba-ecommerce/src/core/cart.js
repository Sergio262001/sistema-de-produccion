...
//  Copiado tal cual de carrito-reutilizable: no depende de UI ni
//  de motor de base de datos. El límite de stock se aplica en la
//  UI de esta base (Math.min(qty, producto.stock)), no aquí.
// ════════════════════════════════════════════════════════════
